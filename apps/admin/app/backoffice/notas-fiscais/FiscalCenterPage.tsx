...
import {
  emitirNFeAction, emitirNFeTesteAction,
  deleteNfeAction, archiveNfeAction, unarchiveNfeAction,
} from "./emitir-action";
import { NfeCopyButton, NfeEditButton } from "./NfeRowActions";
...
export const FISCAL_SECTIONS = [
  { id: "visao-geral", label: "Visão geral", href: "/backoffice/notas-fiscais" },
  { id: "governo", label: "Conexão Governo", href: "/backoffice/notas-fiscais/governo" },
  ...
  { id: "guias", label: "Guias e pagamentos", href: "/backoffice/notas-fiscais/guias" },
  { id: "agenda", label: "Agenda fiscal", href: "/backoffice/notas-fiscais/agenda" },
  { id: "certificados", label: "Certificados digitais", href: "/backoffice/notas-fiscais/certificados" },
  { id: "cofre", label: "Cofre fiscal", href: "/backoffice/notas-fiscais/cofre" },
  { id: "contador", label: "Central do Contador", href: "/backoffice/notas-fiscais/contador" },
  { id: "aprovacoes", label: "Aprovações", href: "/backoffice/notas-fiscais/aprovacoes" },
  { id: "filas", label: "Filas", href: "/backoffice/notas-fiscais/filas" },
  { id: "relatorios", label: "Relatórios", href: "/backoffice/notas-fiscais/relatorios" },
  { id: "auditoria", label: "Auditoria", href: "/backoffice/notas-fiscais/auditoria" },
] as const;

export type FiscalSectionId = (typeof FISCAL_SECTIONS)[number]["id"];
...
export async function FiscalCenterPage({
  ...
  const [
    ...
    supabase
      .from("nfe_documents")
      .select("id, order_id, numero, serie, ambiente, status, valor_total_cents, chave_acesso, protocolo, motivo_status, emitida_at, archived_at, created_at, orders(number)")
      .eq("tenant_id", staff.tenantId)
  ...
  return (
    <div style={pageStyle}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          {FISCAL_SECTIONS.map((section) => (
            <Link
              key={section.id}
              href={section.href}
              className={`fiscal-subsection-link${activeSection === section.id ? " fiscal-subsection-link-active" : ""}`}
            >
              {section.label}
            </Link>
          ))}
      ...
      <section id="visao-geral" className={sectionClass("visao-geral")} style={kpiGridStyle}>
      ...
      {show("governo") ? <FiscalGovernmentPanel connections={integrations} /> : null}

      <section id="integracoes" className={sectionClass("governo", "glass")} style={noticeStyle}>
      ...
      <section id="documentos" className={sectionClass("documentos", "glass")} style={cardStyle}>
      ...
      <div className={sectionClass("documentos", "fiscal-form-grid")}>
        <FiscalDocumentForm />
        <FiscalProductRuleForm />
      </div>

      <section id="eventos" className={sectionClass("eventos")} style={twoColumnStyle}>
      ...
      <section id="rejeicoes" className={sectionClass("rejeicoes", "glass")} style={cardStyle}>
      ...
      <section id="apuracao" className={sectionClass("apuracao")} style={twoColumnStyle}>
        <div className="glass" style={cardStyle}>
      ...
      <section id="guias" className={sectionClass("guias", "glass")} style={cardStyle}>
      ...
      <section id="certificados" className={sectionClass("certificados", "glass")} style={cardStyle}>
      ...
      <section id="aprovacoes" className={sectionClass("aprovacoes", "glass")} style={cardStyle}>
      ...
      <section id="filas" className={sectionClass("filas", "glass")} style={cardStyle}>
