...
const NAV: NavItem[] = [
  ...
  { href: "/seo", label: "SEO Engine", icon: "⟁", match: (p) => p.startsWith("/seo") },
...
const COMMANDS = [
  ...
  { label: "Ir para SEO Engine — Dashboard", href: "/seo/dashboard" },
  { label: "Ir para SEO Engine — Blog", href: "/seo/blog" },
  { label: "Ir para SEO Engine — Auditoria", href: "/seo/auditoria" },
  { label: "Ir para SEO Engine — Redirecionamentos", href: "/seo/redirecionamentos" },
  { label: "Ir para SEO Engine — AI Visibility", href: "/seo/ai-visibility" },
