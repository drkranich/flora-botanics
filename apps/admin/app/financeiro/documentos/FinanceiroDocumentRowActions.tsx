 ...
 * Reutiliza as Server Actions de /documentos (que já são bundladas para o segment /documentos).
 * Para o segment /financeiro, chamamos a action via import direto — o Cloudflare bundla
 * actions por segment mas permite imports cross-segment desde que não causem ambiguidade.
 * Se houver UnrecognizedActionError, duplicar as actions em /financeiro/documentos/actions.ts.
 */
      ...
      {open && (
        <>
          ...
          <div style={{
            ...
            borderRadius: 8, minWidth: 170, zIndex: 100, overflow: "hidden",
