...
const CHANNEL_OPTIONS = [
  { value: "", label: "Sem canal especifico" },
  { value: "site", label: "Site proprio" },
  ...
  return (
    <section className="glass rise rise-2" style={{ padding: 22 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 14, alignItems: "flex-start", marginBottom: open ? 18 : 0 }}>
        <div>
          <p className="eyebrow" style={{ marginBottom: 7 }}>Tabelas de preco</p>
          <h2 className="display" style={{ fontSize: 28 }}>Condicoes por canal</h2>
          <p className="muted" style={{ margin: "8px 0 0", fontSize: 12, lineHeight: 1.7 }}>
            Use para varejo, atacado, B2B, marketplaces, representantes, regioes, campanhas e assinaturas.
          </p>
        </div>
        ...
        <form action={createPriceTable} style={{ display: "grid", gap: 14 }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(190px, 1fr))", gap: 12 }}>
            ...
            <label style={{ display: "flex", gap: 10, alignItems: "center", fontSize: 12.5, color: "var(--cream-soft)" }}>
              ...
              Exigir aprovacao para usar esta tabela
            </label>
            <label className="field">
              <span>Pagamento</span>
            ...
            <label className="field" style={{ gridColumn: "1 / -1" }}>
              ...
              <textarea className="input" name="notes" rows={3} placeholder="Regras, excecoes e limites comerciais." />
            </label>
          </div>
