...
export const MARKETING_MODULES = [
  ...
  { id: "mensagens-transacionais", label: "Mensagens transacionais" },
  { id: "pos-venda", label: "Pós-venda" },
  { id: "carrinhos-abandonados", label: "Carrinhos abandonados" },
  ...
  { id: "testes-ab", label: "Testes A/B" },
  { id: "relatorios", label: "Relatórios" },
  { id: "consentimentos", label: "Consentimentos" },
  { id: "configuracoes", label: "Configurações" },
  { id: "logs-e-integracoes", label: "Logs e integrações" },
] as const;

export type MarketingModuleId = (typeof MARKETING_MODULES)[number]["id"];

const MODULE_SECTIONS: Record<MarketingModuleId, string[]> = {
  "visao-geral": ["visao-geral", "modelos-prontos", "relatorios"],
  campanhas: ["campanhas"],
  automacao: ["jornadas", "webhooks"],
  "email-marketing": ["e-mail-marketing", "webhooks"],
  templates: ["modelos-prontos", "e-mail-marketing"],
  sms: ["campanhas", "integracoes", "webhooks"],
  "whatsapp-business": ["campanhas", "integracoes", "webhooks"],
  "mensagens-transacionais": ["jornadas", "consentimentos", "webhooks"],
  "pos-venda": ["jornadas", "timeline-relatorios"],
  "carrinhos-abandonados": ["jornadas", "timeline-relatorios"],
  segmentos: ["segmentos"],
  publicos: ["segmentos"],
  jornadas: ["jornadas"],
  cupons: ["campanhas", "atribuicao"],
  "landing-pages": ["landing-pages"],
  "meta-ads": ["atribuicao", "integracoes"],
  "google-ads": ["atribuicao", "integracoes"],
  atribuicao: ["atribuicao", "timeline-relatorios"],
  conversoes: ["atribuicao", "timeline-relatorios"],
  leads: ["segmentos", "timeline-relatorios"],
  calendario: ["calendario"],
  aprovacoes: ["aprovacoes"],
  custos: ["custos", "relatorios"],
  "testes-ab": ["experimentos"],
  relatorios: ["timeline-relatorios", "relatorios"],
  consentimentos: ["consentimentos"],
  configuracoes: ["integracoes"],
  "logs-e-integracoes": ["integracoes", "webhooks", "relatorios"],
};

export function isMarketingModuleId(value: string): value is MarketingModuleId {
  return MARKETING_MODULES.some((module) => module.id === value);
}
...
export async function MarketingCenterPage({
  activeModule = "visao-geral",
}: {
  activeModule?: MarketingModuleId;
} = {}) {
  ...
  if (foundationError) {
    return (
      <main style={pageStyle}>
        <Header activeModuleLabel="Visão geral" />
  ...
  const activeModuleLabel = MARKETING_MODULES.find((module) => module.id === activeModule)?.label ?? "Visão geral";

  return (
    <main style={pageStyle}>
      <Header activeModuleLabel={activeModuleLabel} />

      <section id="visao-geral" className="rise" style={sectionStyle(activeModule, "visao-geral", kpiGridStyle)}>
      ...
      <section className="glass rise rise-1" style={cardStyle}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          {MARKETING_MODULES.map((module) => (
            <Link
              key={module.id}
              href={marketingModuleHref(module.id)}
              className={activeModule === module.id ? "finance-subsection-link finance-subsection-link-active" : "finance-subsection-link"}
            >
              {module.label}
            </Link>
          ))}
      ...
      <section className="glass rise rise-1" style={sectionStyle(activeModule, "modelos-prontos", cardStyle)}>
      ...
      <section id="campanhas" style={sectionStyle(activeModule, "campanhas", twoColumnStyle)}>
      ...
      <section id="e-mail-marketing" style={sectionStyle(activeModule, "e-mail-marketing", twoColumnStyle)}>
      ...
      <section id="segmentos" style={sectionStyle(activeModule, "segmentos", twoColumnStyle)}>
      ...
      <section id="jornadas" style={sectionStyle(activeModule, "jornadas", twoColumnStyle)}>
      ...
      <section id="landing-pages" style={sectionStyle(activeModule, "landing-pages", twoColumnStyle)}>
      ...
      <section id="consentimentos" style={sectionStyle(activeModule, "consentimentos", twoColumnStyle)}>
      ...
      <section id="atribuicao" style={sectionStyle(activeModule, "atribuicao", twoColumnStyle)}>
      ...
      <section id="calendario" style={sectionStyle(activeModule, "calendario", twoColumnStyle)}>
      ...
      <section id="aprovacoes" style={sectionStyle(activeModule, "aprovacoes", twoColumnStyle)}>
      ...
      <section id="custos" style={sectionStyle(activeModule, "custos", twoColumnStyle)}>
      ...
      <section id="integracoes" style={sectionStyle(activeModule, "integracoes", twoColumnStyle)}>
      ...
      <section id="webhooks" style={sectionStyle(activeModule, "webhooks", twoColumnStyle)}>
      ...
      <section id="experimentos" style={sectionStyle(activeModule, "experimentos", twoColumnStyle)}>
      ...
      <section id="timeline-relatorios" style={sectionStyle(activeModule, "timeline-relatorios", twoColumnStyle)}>
      ...
      <section id="relatorios" className="glass rise" style={sectionStyle(activeModule, "relatorios", cardStyle)}>
...
function Header({ activeModuleLabel }: { activeModuleLabel: string }) {
  return (
    <header className="rise" style={{ marginBottom: 26 }}>
      ...
      <span className="chip chip-live" style={{ marginTop: 10 }}>Módulo: {activeModuleLabel}</span>
...
export function marketingModuleHref(moduleId: MarketingModuleId) {
  return moduleId === "visao-geral" ? "/marketing" : `/marketing/${moduleId}`;
}

function isSectionVisible(activeModule: MarketingModuleId, sectionId: string) {
  return MODULE_SECTIONS[activeModule]?.includes(sectionId) ?? false;
}

function sectionStyle(activeModule: MarketingModuleId, sectionId: string, style: CSSProperties): CSSProperties {
  return isSectionVisible(activeModule, sectionId) ? style : { ...style, display: "none" };
}
