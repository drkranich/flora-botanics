...
const INTEGRATIONS: Integration[] = [
  ...
  {
    key: "integration_carrefour",
    providerKey: "carrefour",
    icon: "⬡",
    title: "Carrefour",
    description: "Venda no marketplace do Carrefour com sincronização de estoque e pedidos.",
    docsUrl: "https://marketplace.carrefour.com.br",
    fields: [
      {
        name: "seller_id",
        label: "Seller ID",
        placeholder: "CARRE-12345",
        hint: "Seu identificador de vendedor no Carrefour Marketplace.",
      },
      {
        name: "client_id",
        label: "Client ID",
        placeholder: "carrefour_client_id",
        hint: "Client ID gerado no painel do Carrefour Marketplace.",
      },
      {
        name: "client_secret",
        label: "Client Secret",
        placeholder: "carrefour_secret…",
        type: "password",
        hint: "Client Secret para autenticação OAuth no Carrefour.",
      },
      {
        name: "access_token",
        label: "Access Token",
        placeholder: "eyJ…",
        type: "password",
        hint: "Token de acesso obtido após o fluxo OAuth.",
        required: false,
      },
    ],
  },
  {
    key: "integration_casas_bahia",
    providerKey: "casas_bahia",
    icon: "⬢",
    title: "Casas Bahia",
    description: "Catálogo e pedidos integrados ao marketplace das Casas Bahia.",
    docsUrl: "https://sellers.casasbahia.com.br",
    fields: [
      {
        name: "seller_id",
        label: "Seller ID",
        placeholder: "CB-12345",
        hint: "Seu identificador de vendedor nas Casas Bahia.",
      },
      {
        name: "client_id",
        label: "Client ID",
        placeholder: "casasbahia_client_id",
        hint: "Client ID gerado no painel de sellers das Casas Bahia.",
      },
      {
        name: "client_secret",
        label: "Client Secret",
        placeholder: "casasbahia_secret…",
        type: "password",
        hint: "Client Secret para autenticação OAuth das Casas Bahia.",
      },
      {
        name: "access_token",
        label: "Access Token",
  ...
  {
    key: "integration_americanas",
    providerKey: "americanas",
    icon: "◆",
    title: "Americanas",
    description: "Publicação de produtos e importação de pedidos da Americanas.",
    docsUrl: "https://sellers.americanas.com.br",
    fields: [
      {
        name: "seller_id",
        label: "Seller ID",
        placeholder: "AME-12345",
        hint: "Seu identificador de vendedor nas Americanas.",
      },
      {
        name: "client_id",
        label: "Client ID",
        placeholder: "americanas_client_id",
        hint: "Client ID gerado no painel de sellers das Americanas.",
      },
      {
        name: "client_secret",
        label: "Client Secret",
        placeholder: "americanas_secret…",
        type: "password",
        hint: "Client Secret para autenticação OAuth das Americanas.",
      },
      {
        name: "access_token",
        label: "Access Token",
  ...
  {
    key: "integration_magalu",
    providerKey: "magalu",
    icon: "◇",
    title: "Magalu",
    description: "Sincronize catálogo, estoque e pedidos com o Magazine Luiza.",
    docsUrl: "https://sellers.magalu.com",
    fields: [
      {
        name: "seller_id",
        label: "Seller ID",
        placeholder: "MGL-12345",
        hint: "Seu identificador de vendedor no Magalu.",
      },
      {
        name: "client_id",
        label: "Client ID",
        placeholder: "magalu_client_id",
        hint: "Client ID gerado no painel de sellers do Magalu.",
      },
      {
        name: "client_secret",
        label: "Client Secret",
        placeholder: "magalu_secret…",
        type: "password",
        hint: "Client Secret para autenticação OAuth do Magalu.",
      },
      {
        name: "access_token",
        label: "Access Token",
      ...
      },
      {
        ...
        placeholder: "eyJ…",
        type: "password",
        hint: "Token para renovar o access_token automaticamente.",
        required: false,
      },
    ],
  },
